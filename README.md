...
* pf - напечатать матрицу в виде несократимой дроби, делает первое число в строке единицей, остальные сокращает (не меняет матрицу)
* pd - pdk (k необязательный параметр кол-во знаков после запятой) печатает матрицу в виде десятичных дробей, по стандарту округляет до 2 знаков (не меняет матрицу). 
3) Основные команды
